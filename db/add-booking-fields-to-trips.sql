-- Add comprehensive booking fields to trips table for booking_mobile
...
--
-- booking_mobile currently doesn't use building/apartment fields, but if needed in the future,
-- use the existing column names from facility_app to avoid duplication.
